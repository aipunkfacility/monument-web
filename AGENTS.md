...
5. **Цены** — 3 карточки: портретная ретушь (700₽), сложная ретушь (1 000–1 500₽), для мастерских (индивидуально)
6. **FAQ** — аккордеон с 8 вопросами
7. **Почему нам доверяют** — 4 бейджа
8. **Контакты** — Telegram, WhatsApp, Email
